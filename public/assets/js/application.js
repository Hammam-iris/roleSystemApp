...
/****  Play & Rotate Buttons Toggle  ****/
function playtest(){
  APP.togglePlay();
  if($("#playingIcon").hasClass( "fa-play" )){
         $("#playingIcon").removeClass('fa-play');
         $("#playingIcon").addClass('fa-pause');     
  }else{
         $("#playingIcon").removeClass('fa-pause');
         $("#playingIcon").addClass('fa-play');
  }
}

function rotateToggle(){
  if($("#rotateIcon").hasClass( "icon-reload" )){
         $("#rotateIcon").removeClass('icon-reload');
         $("#rotateIcon").addClass('fa fa-arrows'); 
         $( "#rotText" ).text("Translate");  

  }else if($("#rotateIcon").hasClass( "fa-arrows" )){
         $("#rotateIcon").removeClass('fa fa-arrows');
         $("#rotateIcon").addClass('fa fa-search');
         $( "#rotText" ).text("Zoom"); 

  }else if($("#rotateIcon").hasClass( "fa-search" )){
         $("#rotateIcon").removeClass('fa-search');
         $("#rotateIcon").addClass('icon-reload');
         $( "#rotText" ).text("Rotate");  
...
function handlePanelAction() {
    ...
    function handlePanelControls() {
        $('.panel-controls').each(function() {
            var controls_html = '<div class="control-btn">' + '<a class="" id="dropdownMenu1" data-toggle="dropdown">' + '<i class="icon-settings"></i>' + '</a>' + '<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">' + '<li class="active"><a href="#">Treatment 1 | 12/03/2018</a>' + '</li>' + '<li><a href="#">Treatment 2 | 18/02/2017</a>' + '</li>' + '<li><a href="#">Treatment 3 | 03/11/2015</a>' + '</li>' + '</ul>' + '</div>';
            $(this).append(controls_html);
        });
        $('.md-panel-controls').each(function() {
            var controls_html = '<div class="control-btn">' + '<a href="#" class="panel-reload "><i class="mdi-av-replay"></i></a>' + '<a class="" id="dropdownMenu1" data-toggle="dropdown">' + '<i class="mdi-action-settings"></i>' + '</a>' + '<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">' + '<li><a href="#">Action</a>' + '</li>' + '<li><a href="#">Another action</a>' + '</li>' + '<li><a href="#">Something else here</a>' + '</li>' + '</ul>' + '<a href="#" class="panel-popout  tt" title="Pop Out/In"><i class="mdi-action-open-in-browser"></i></a>' + '<a href="#" class="panel-maximize "><i class="mdi-action-launch"></i></a>' + '<a href="#" class="panel-toggle"><i class="mdi-navigation-expand-more"></i></a>' + '<a href="#" class="panel-close"><i class="mdi-action-delete"></i></a>' + '</div>';
            $(this).append(controls_html);
        });
    }
    handlePanelControls();
